...
--
-- Dumping data for table `NotificationEvents`
--

LOCK TABLES `NotificationEvents` WRITE;
/*!40000 ALTER TABLE `NotificationEvents` DISABLE KEYS */;
/*!40000 ALTER TABLE `NotificationEvents` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-09 20:11:30
