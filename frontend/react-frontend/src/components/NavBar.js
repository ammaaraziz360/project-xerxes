                    ...
                    <div className="d-flex col-3 justify-content-end align-items-center">
                        <div className="dropdown sub">
                            ...
                            <a className="" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                {Props.isLoggedInState ? <img src="https://lh3.googleusercontent.com/a-/AOh14GjQ75MzIig737ug-yQInIeKnEcbUhkbHjY4vMj4-w=s96-c" className="image-fluid pfp"></img>
                            ...
                            <ul className="dropdown-menu m-3" aria-labelledby="dropdownMenuLink">
                                {Props.isLoggedInState ? [<li key={1}><Link to="/" className="dropdown-item">Profile</Link></li>,
                                                            <li key={2}><Link to="/"className="dropdown-item">Settings</Link></li>,
                                                            <li key={3}><a className="dropdown-item" onClick={() => Props.setIsLoggedIn(false)}>Log out</a></li>]
